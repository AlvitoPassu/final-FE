        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700 mb-12">
            <div className="flex flex-col sm:flex-row items-center gap-8">
              <div className="w-24 h-24 bg-linear-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-lg">
          ...
          <div>
            ...
            {!loading && !error && invitations.length === 0 && (
              <div className="text-center bg-white dark:bg-gray-800 rounded-lg p-12 shadow-md">
                ...
                <Link to="/template" className="mt-6 inline-block bg-linear-to-r from-indigo-500 to-purple-600 text-white hover:from-purple-600 hover:to-indigo-500 duration-300 rounded-lg px-8 py-3 font-bold shadow-lg hover:shadow-xl transition-shadow">Buat Undangan Sekarang</Link>
              </div>
            )}
